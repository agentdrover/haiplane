...
#: нужны ни токен, ни сеть), #1146 — для ВЫЗОВОВ на гейтах, #1118 — для
#: провижининга, которое обязано спросить ИМЕННО тот форж, что объявлен у
#: проекта. Три карты с одинаковым содержимым разошлись бы ровно там, где это
#: дороже всего: добавили третий форж в одну — и ссылки на него ведут в никуда,
#: либо вызовы уходят в GitHub, либо провижининг клонирует не оттуда.
