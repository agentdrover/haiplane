...
_MIGRATIONS: list[tuple[str, str]] = [
    ...
    (
        ...
        # nowhere a payload can land (#780). 0 is "schema matched"; a positive
        # number is the discarded-field warning made countable.
        "add_mcp_call_events_unknown_arg_count",
        "ALTER TABLE mcp_call_events ADD COLUMN unknown_arg_count "
